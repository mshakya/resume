...
{\bf Dissertation} Validating Approaches for Studying Microbial Diversity to Characterize Communities from Roots of \textit{Populus deltoides}
...
\item Developing pipeline for RNA-seq data analysis to DE genes in eukaryotes and prokaryotes.
\item Developing pipeline for evolutionary analysis based on SNPs and maximum likelihood. 
\end{rSubsection}

%------------------------------------------------
\begin{rSubsection}{Postdoctoral Associate} {2013 - 2016}{}{}
\item Department of Biology, Dartmouth College, Hanover, NH
\item Evolution of Gene Transfer Agents across Alphaproteobacteria
\item Developing SVM-based algorithm to distinguish phage genes from GTA homologs.
\end{rSubsection}
...
{\bf Bioinformatics}: Genome, Microbial ecology, Metagenome, Metagenetics, Methylome, SNP analysis, phylogenetics, etc.\\
